            ...
            @forelse($clients as $client)
                <tr>
                    ...
                    <td>
                        ...
                        @if($client->message)
                            <button class="btn btn-link btn-sm p-0 text-decoration-none text-muted" data-bs-toggle="collapse"
                                data-bs-target="#note-{{ $client->id }}">
                    ...
                    <td>
                        <div class="small fw-bold">
                            {{ \Carbon\Carbon::parse($client->booking_date)->format('D, d M Y') }}
                        </div>
