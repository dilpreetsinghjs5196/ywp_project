...
<footer class="footer py-5 px-4">
  ...
  <div class="b-container">
    <div class="row pt-5 gx-lg-5 px-0">
      <div class="footer-logo col-12 col-lg-5 mb-5 mb-lg-0 text-lg-start text-center">
        ...
        <div class="social-box d-flex justify-content-lg-start justify-content-center w-100">
          <a href="https://www.facebook.com/yourewonderfulproject" class="rounded-5 py-2"
            style="width: 40px; height: 40px;" target="_blank"><i class="bi bi-facebook text-white"></i></a>
          <a href="https://www.instagram.com/yourewonderfulproject/?hl=en" class="rounded-5 py-2"
            style="width: 40px; height: 40px;" target="_blank"><i class="bi bi-instagram text-white"></i></a>
          <a href="https://www.linkedin.com/company/ywpindia/" class="rounded-5 py-2" style="width: 40px; height: 40px;"
            target="_blank"><i class="bi bi-linkedin text-white"></i></a>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-lg-4 mb-5 mb-lg-0 text-lg-start text-center">
        ...
        <div class="d-flex flex-column align-items-lg-start align-items-center">
          <p class="mb-3">{{ $settings['office_address'] ?? '22, Asaf Ali Rd, Kucha Pati Ram, Ajmeri Gate, New Delhi' }}
          </p>
    ...
    <div class="row justify-content-center py-4 mt-5 border-top">
      <p class="text-center w-100 mb-0">Copyright &copy; 2026. All Rights Reserved. Designed by <a
