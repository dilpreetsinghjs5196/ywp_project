            ...
            <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="blog_theme_id" class="form-select @error('blog_theme_id') is-invalid @enderror">
                            ...
                            @foreach($themes as $theme)
                                <option value="{{ $theme->id }}" {{ old('blog_theme_id') == $theme->id ? 'selected' : '' }}>{{ $theme->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="summary" class="form-control" rows="2" placeholder="Brief summary of the post">{{ old('summary') }}</textarea>
                    </div>
