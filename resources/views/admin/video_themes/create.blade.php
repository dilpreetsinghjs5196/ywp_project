...
@section('title', 'Add New Video Theme')
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold">Create Video Theme</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.video-themes.store') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" id="nameInput" class="form-control @error('name') is-invalid @enderror" 
                                    value="{{ old('name') }}" placeholder="e.g. Mental Health Awareness">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="slug" id="slugInput" class="form-control @error('slug') is-invalid @enderror" 
                                    value="{{ old('slug') }}" placeholder="mental-health-awareness">
                            ...
                            <div class="col-12 mt-4 pt-3 border-top">
                                ...
                                <a href="{{ route('admin.video-themes.index') }}" class="btn btn-light border px-4 ms-2">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
