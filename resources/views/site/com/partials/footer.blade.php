    ...
    <div class="b-container">
      <div class="row row-cols-1 pt-5 px-0">
        <div class="footer-logo col-12 col-lg-3 mb-5 text-lg-start text-center">
          <img src="{{ asset('image/white-logo.png') }}" alt="Footer Logo" width="200px">
      ...
      <div class="row justify-content-center py-4 mt-4 border-top">
        <p class="text-center w-100 mb-0">Copyright &copy; 2025 Widagdos. All Rights Reserved. Designed by <a href="https://japnaazsoftware.com/" target="_blank" style="color: #ffbf00;font-weight: 600;">Japnaaz Software</a></p>
      </div>
    </div>
  </footer>
  <!-- #footer end -->
