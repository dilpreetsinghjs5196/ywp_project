...
@section('title', 'Manage Blog Themes')
@section('page_title', 'Blog Content Categorization')

@section('content')
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold">Blog Themes</h5>
            <a href="{{ route('admin.blog-themes.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-lg me-1"></i> Add New Theme
            </a>
        </div>
        <div class="card-body bg-light border-bottom p-3">
            <form id="filterForm" action="{{ route('admin.blog-themes.index') }}" method="GET" class="row g-2">
                <div class="col-md-5">
                ...
                <div class="col-md-2">
                    ...
                    <a href="{{ route('admin.blog-themes.index') }}" id="clearBtn"
        ...
        <div class="card-body p-0" id="tableContainer">
            @include('admin.blog_themes._table')
        </div>
    </div>
@endsection
