        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold">Edit Theme: {{ $theme->name }}</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.blog-themes.update', $theme->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12 mt-4 pt-3 border-top">
                                ...
                                <a href="{{ route('admin.blog-themes.index') }}"
