...
@section('content')
    <div class="card p-4">
        ...
        <div class="card-body bg-light border-bottom p-3 mb-3 rounded">
            <form id="filterForm" action="{{ route('admin.users.index') }}" method="GET" class="row g-2">
                <div class="col-md-5">
                ...
                <div class="col-md-2">
                    ...
                    <a href="{{ route('admin.users.index') }}" id="clearBtn"
